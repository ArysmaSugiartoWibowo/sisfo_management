                                    ...
                                    <?php foreach ($laporans as $l): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?= anchor(site_url("Laporan/tolak/" . $l->id_laporan), '<i class="fa fa-trash"></i> Tolak', 'class="btn btn-danger btn-sm" title="Tolak"') ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
...
<div class="modal fade" id="activateModal" tabindex="-1" role="dialog" aria-labelledby="activateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo site_url('/Laporan/ubah_status_dan_upload'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <label for="sertifikat">Sertifikat</label>
                        <input type="file" name="sertifikat" id="sertifikat" class="form-control" accept=".pdf" required>
                    </div>
                </div>
